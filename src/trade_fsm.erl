...
%% for the ready state. State should transaction to 'ready'
am_ready(OtherPid) ->
...
negotiate({undo_offer, Item}, S=#state{otheritems = OterItems}) ->
  notice(S, "Other player cancelling offer on~p", [Item]),
  {next_state, negotiate, S#state{otheritems = remove(Item, OterItems)}};
